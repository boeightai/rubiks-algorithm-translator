...
const Header = ({ 
  ...
  subtitle = "A father-daughter picture-move system for learning the beginner method",
  style = {},
  onModeToggle,
  currentMode
}) => {
        ...
        <div style={{
          ...
          {onModeToggle && currentMode && (
            <button
              ...
              aria-label={currentMode === 'tutorial' ? "Open Move Library" : "Open beginner method"}
              title={currentMode === 'tutorial' ? "Open Move Library" : "Open beginner method"}
            >
              {currentMode === 'tutorial' ? (
                ...
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M12 6.5a7 7 0 0 0-7-2v14a7 7 0 0 1 7 2" />
                  <path d="M12 6.5a7 7 0 0 1 7-2v14a7 7 0 0 0-7 2" />
                  <path d="M12 6.5v14" />
                </svg>
              )}
              <span>{currentMode === 'tutorial' ? 'Move Library' : 'Learn Method'}</span>
            </button>
          )}
